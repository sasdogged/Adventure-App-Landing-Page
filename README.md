# Simple Adventure App Landing Page
...
- Adventure App is a single-page landing site built in React, deployed on Vercel. It’s a portfolio project that showcases an imaginary travel/adventure app, made to test and consolidate the React skills I’ve learned so far.
  ...
  - It’s also a way to showcase that I can build something polished and live.
 
  ## 💡 Features / What’s in the App
   - Header and Navigation section
  - Call to Action (CTA): Designed to drive user engagement.
  - Responsive layout: Looks good on desktop and mobile.
  - Hero section: Engaging header to hook users.
  - Feature sections: To highlight the key value propositions of the (hypothetical) app.
